 ...
 * @author Usuario
 */
public class CRUDProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbSubtitulo.setText("Proveedores");
        ...
        btnAgregar.setText("Nuevo proovedor");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        POPProveedores pGestion = new POPProveedores();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        Proveedor proveedor = gestor.seleccionarProveedor(tblDatos);
        if (proveedor != null){
            POPProveedores pGestion = new POPProveedores();
            pGestion.setCrud(this);
            pGestion.setEditando(true, proveedor);
            pGestion.setLocationRelativeTo(null);
            pGestion.setVisible(true);
            this.setEnabled(false);
        }
    ...
    public void cargarDatosTabla(){
        ProveedoresDB gestor = new ProveedoresDB();
        gestor.cargarProveedores(tblDatos);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRUDProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUDProveedores().setVisible(true);
            }
        });
    }
