 ...
 * @author Usuario
 */
public class CRUDTipoFruta extends javax.swing.JFrame {

    private PantallaPrincipalAdmin pPrincipal;
    /**
     * Creates new form Proveedores
     */
    public CRUDTipoFruta() {
        initComponents();
        cargarDatosTabla();
    }
    ...
    private void initComponents() {
        ...
        lbSubtitulo.setText("Tipos de Fruta");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        POPTipoFruta pGestion = new POPTipoFruta();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        TipoFruto tipo = gestor.seleccionarTipo(tblDatos);
        if (tipo != null){
            POPTipoFruta pGestion = new POPTipoFruta();
            pGestion.setCrud(this);
            pGestion.setEditando(true, tipo);
            pGestion.setLocationRelativeTo(null);
            pGestion.setVisible(true);
            this.setEnabled(false);
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        TipoFruto tipo = gestor.seleccionarTipo(tblDatos);
        if (tipo != null){
            gestor.eliminarTipo(tipo.getId());
            cargarDatosTabla();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRUDTipoFruta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUDTipoFruta().setVisible(true);
            }
        });
    }
